...
function adventureVars() {
  // general
  adventureGame.startingState = 0;
  adventureGame.state = 0;
  adventureGame.previousState = state;
  adventureGame.buttons = {};
  adventureGame.buttonAtributes = {
    race: {},
    skill: {},
    settings: {}
  };
  ...
  // images
  adventureGame.worldBackgrounds = {};
  adventureGame.npcImg = {};
  adventureGame.itemImg = {};
  adventureGame.sprites = {
    race: {},
    skill: {}
  };
  adventureGame.spriteSize = {};

  // race/skill arrays
  adventureGame.allRaces = [];
  adventureGame.allSkills = [];
  adventureGame.raceSpecific = {};
  adventureGame.skillSpecific = {};

  // NPC's
  adventureGame.numOfNPCs = 50;
  adventureGame.allNPCs = [];
  adventureGame.shopKeeps = [];
  adventureGame.shopInventory;
  adventureGame.guildKeepers = [];
  adventureGame.refreshTimer;
  adventureGame.lastRefresh;

  // world
  adventureGame.drawingBack;
  adventureGame.world = {};
  adventureGame.minimap = {};

  // races/skills button arrays
  adventureGame.raceButtons = [];
  adventureGame.skillButtons = [];

  // attacks
  adventureGame.melee = {};
  adventureGame.ranged = {};
  adventureGame.spellCaster = {};

  // items
  adventureGame.allItems;
  adventureGame.numOfItems;
  adventureGame.items = {};
  adventureGame.recentPickUps = "";
  adventureGame.recentsTimer;
  adventureGame.recentsLastTime;
  adventureGame.itemDropEnemy;
  adventureGame.shopItemRefreshName = "";

  // player
  adventureGame.player = {};
  adventureGame.guildMembers = [];

  // inventory
  adventureGame.inventory = {};
  adventureGame.mouseCarring;

  // settings
  adventureGame.settings = {};

  // key-bindings
  adventureGame.keyBindings;
  adventureGame.rebindButtons = [];

  // enemys
  adventureGame.enemyArr = [];
}

function startGameVars() {
  // starting advventure 
  startingState = 0;
  state = 0;
  recentPickUps = "";
