...
function advtSetSprites() {
    ...
    advtVars.races = new Map();
        ...
        // player choices
    advtVars.races.set("Random",   { name: "Random",   img: advtVars.sprites.random,        stats: advtVars.raceStats.secretRace });
    ...
    advtVars.skills = new Map();
        // player choices
    advtVars.skills.set("Random",  { name: "Random",  img: advtVars.sprites.random,        stats: advtVars.skillStats.secretSkill });
...
function advtMinimapVars() {
    // minimap variables
    advtVars.minimap = {};
    advtVars.minimap.dotSize = (width + height) * 0.015;
...
//-----------------------------------------------
// player, inventory, shop and guild-------------
function advtSetPlayer() {
    ...
    // charachter
    player.name = "Namme";
    player.hasGuildCard = false;

    player.race = advtVars.races.get("Random");
    player.skill = advtVars.skills.get("Random");
    ...
    // inventory
    advtSetInventory();
    player.inventory = make2DArray(advtVars.inventory.cols, advtVars.inventory.rows);
}
...
function advtSetShopGuild() {
    ...
    advtVars.shop[0][0] = allItems.get("HP Potion");
    advtVars.shop[0][1] = allItems.get("MP Potion");
    advtVars.shop[0][2] = allItems.get("Arrows");
    advtVars.shop[0][3] = allItems.get("Traps");
    advtVars.shop[0][4] = allItems.get("Town Portal");
