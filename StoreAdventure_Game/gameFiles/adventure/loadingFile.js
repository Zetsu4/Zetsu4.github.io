...
function preloadAdventure() {
  ...
  sprites.race.dwarf = loadImage("assets/img/sprites/dwarf.png");
  sprites.race.elf = loadImage("assets/img/sprites/elf.png");
  sprites.race.goblin = loadImage("assets/img/sprites/goblin.png");
  sprites.race.halfElf = loadImage("assets/img/sprites/half-elf.png");
  sprites.race.halfling = loadImage("assets/img/sprites/halfling.png");
  sprites.race.human = loadImage("assets/img/sprites/human.png");
  sprites.race.orc = loadImage("assets/img/sprites/orc.png");
  sprites.race.urukHai = loadImage("assets/img/sprites/uruk-hai.png");

  // enemy sprites
  sprites.death = loadImage("assets/img/sprites/enemyDeath.png");
  sprites.boss = loadImage("assets/img/sprites/boss.png");

  sprites.race.rat = loadImage("assets/img/sprites/rat.png");
  sprites.race.ghost = loadImage("assets/img/sprites/ghost.png");
  sprites.race.skeleton = loadImage("assets/img/sprites/skeleton.png");
  sprites.race.undeadKnight = loadImage("assets/img/sprites/undeadKnight.png");
  sprites.race.gateGaurd = loadImage("assets/img/sprites/gateGaurd.png");
  sprites.race.gateGaurd2 = loadImage("assets/img/sprites/gateGaurd2.png");
  sprites.race.fireImp = loadImage("assets/img/sprites/fireImp.png");
  sprites.race.demonBig = loadImage("assets/img/sprites/demonBig.png");
  sprites.race.demonSmall = loadImage("assets/img/sprites/demonSmall.png");
  sprites.race.demon1 = loadImage("assets/img/sprites/demon1.png");
  
  // player skills
  sprites.skill.archer = loadImage("assets/img/skills/archer.png");
  sprites.skill.cleric = loadImage("assets/img/skills/cleric.png");
  sprites.skill.fighter = loadImage("assets/img/skills/fighter.png");
  sprites.skill.mage = loadImage("assets/img/skills/mage.png");
  sprites.skill.ranger = loadImage("assets/img/skills/ranger.png");
  sprites.skill.rogue = loadImage("assets/img/skills/rogue.png");
  sprites.skill.samurai = loadImage("assets/img/skills/samurai.png");
  sprites.skill.trapper = loadImage("assets/img/skills/trapper.png");

  // enemy skills
  sprites.skill.knight = loadImage("assets/img/skills/knight.png");
  sprites.skill.spiritMage = loadImage("assets/img/skills/spiritMage.png");
  sprites.skill.demonMelee = loadImage("assets/img/skills/demonMelee.png");
  sprites.skill.demonMagic = loadImage("assets/img/skills/demonMagic.png");
  sprites.skill.boss = loadImage("assets/img/skills/boss.png");
