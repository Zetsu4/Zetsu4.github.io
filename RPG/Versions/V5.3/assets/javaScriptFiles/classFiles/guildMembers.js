class GuildMember {
  constructor(race, skill, lvl, attackConstructor = Attack, wid = spriteSize.width, hei = spriteSize.height, fontSizeChange = fontSize.playersDisplay, deathImage = sprites.death) {
    // position
